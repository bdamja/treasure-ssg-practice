tellraw @a "initializing treasure prac map datapack"
...
execute as @a unless score @s has_settings matches 0.. run function treasure:settings/defaults

# set constants
scoreboard players set 2 nums 2

# forceload certain chunks
function treasure:util/forceload
